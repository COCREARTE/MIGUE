...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20220704_studio97musiclab_686db8086d8769914384_20230713064139_archive.daf';
        const ARCHIVE_SIZE       = '165017534';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '686db80-13064139';
        const SECONDARY_PACKAGE_HASH = '8a7af55-13064139';
        const VERSION            = '1.5.0';
